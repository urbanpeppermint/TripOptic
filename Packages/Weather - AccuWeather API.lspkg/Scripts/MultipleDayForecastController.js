...
var init = function() {
    if (checkInputs()) {
        ...
        script.accuweatherAPI.getCurrentConditionAndForecast(desiredCity.latitude, desiredCity.longitude, function(err, parsedBody) {
            ...
            if (!err) {
                ...
                var currUiWeatherDay = script.uiWeatherDays[0];
                ...
                for (var i = 1; i < dailyForecast.length && i < script.uiWeatherDays.length; i++) {
                    ...
                    currUiWeatherDay = script.uiWeatherDays[i];
                    currUiWeatherDay.setCondition(currentCondition.condition);
                    currUiWeatherDay.setTemperature(currentCondition.temperatureF);
