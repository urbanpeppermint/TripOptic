...
script.getCurrentConditionAndForecast = getCurrentConditionAndForecast;
script.getCurrentCondition = getCurrentCondition;
script.getHourlyForecast = getHourlyForecast;
script.getDailyForecast = getDailyForecast;
